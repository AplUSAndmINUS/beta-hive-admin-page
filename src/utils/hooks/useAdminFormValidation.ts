...
export const useAdminFormValidation = () => {
  const validationRules = {
    battleName: (value: string) => {
      console.log('Validating battleName:', { value, type: typeof value });
    ...
    minWordCount: (value: number) => {
      console.log('Validating minWordCount:', { value, type: typeof value });
    ...
    maxWordCount: (value: number) => {
      console.log('Validating maxWordCount:', { value, type: typeof value });
    ...
    minPromptSelections: (value: number) => {
      console.log('Validating minPromptSelections:', {
        value,
        type: typeof value,
      });
    ...
    numOfLosses: (value: number) => {
      console.log('Validating numOfLosses:', { value, type: typeof value });
    ...
    contentWarnings: (value: any[]) => {
      console.log('Validating contentWarnings:', {
        value,
        length: value?.length,
        isArray: Array.isArray(value),
      });
